...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-brand to-brand-light p-12 flex-col justify-between">
        <div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="text-sm text-brand-light hover:underline">
                  Forgot password?
                </button>
              </div>
              <Input
            ...
            <Button type="submit" disabled={isLoading} className="w-full bg-brand text-white hover:bg-brand-light">
              {isLoading ? (
                <>
          ...
          <div className="mt-8 text-center">
            <p className="text-neutral-400 text-sm">
              Need help? Contact{" "}
              <a href="mailto:support@theskitbit.com" className="text-brand-light hover:underline">
