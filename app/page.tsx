...
export default function Page() {
  ...
  const pricingStructuredData = {
    ...
    name: "خدماتنا",
    description:
      "خدمات شاملة للمستثمرين ورجال الأعمال في تأسيس الشركات والتسويق والسياحة",
        ...
        <div className="container mx-auto px-4 py-12 sm:py-16">
          <Card className="relative overflow-hidden rounded-3xl liquid-glass p-6 sm:p-10">
            <div className="relative grid items-center gap-8 md:grid-cols-2">
              {/* Left copy */}
              <div>
                <p className="mb-2 text-[11px] tracking-widest text-brand-light">
                  سهولة التواصل
                </p>
                ...
                <p className="mt-2 max-w-prose text-sm text-neutral-400">
                  استعرض خدماتنا، تابع حالة طلبك، وتواصل معنا مباشرة عبر
                  الواتساب لأي استفسار أو طلب جديد
                </p>
              </div>
                  ...
                  <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl bg-white">
                    ...
                    <div className="relative p-8 md:p-12">
                      <div className="space-y-3">
                        <div className="text-7xl md:text-8xl lg:text-9xl font-extrabold text-brand-light">
                          متابعة سهلة
                        </div>
                        <p className="text-base md:text-lg lg:text-xl text-gray-600">
                          من الطلب إلى التنفيذ بكل سلاسة
                        </p>
