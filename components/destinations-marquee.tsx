...
export function DestinationsMarquee() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-white/70 via-white/30 to-white/70 z-10 pointer-events-none" />
      ...
      <div className="absolute top-0 left-0 right-0 z-20 pt-16 pb-8 px-4 text-center pointer-events-none">
        ...
        <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl mb-6 text-gray-900 drop-shadow-[0_2px_10px_rgba(255,255,255,0.8)]">
          <span className="block">اكتشف العالم</span>
          <span className="block text-brand-light drop-shadow-[0_0_20px_rgba(5,79,152,0.25)]">
            مع خدماتنا السياحية
          </span>
        </h2>
        <p className="text-gray-700 text-lg max-w-2xl mx-auto leading-relaxed drop-shadow-[0_2px_8px_rgba(255,255,255,0.6)]">
