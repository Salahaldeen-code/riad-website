    ...
    <section className="bg-[#0a0a0a] text-white py-16 sm:py-20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          {/* Badge */}
          <div className="mb-6 inline-flex items-center rounded-full bg-gradient-to-r from-brand/20 to-brand-light/20 border border-brand/30 px-4 py-2 text-sm font-medium text-brand-light">
            Our Clients
          </div>

          {/* Heading */}
          <h2 className="mb-4 bg-gradient-to-r from-brand via-brand-light to-brand bg-clip-text text-4xl font-bold text-transparent sm:text-5xl md:text-6xl">
            Over 100+ company
          </h2>
          ...
          {/* CTA Button */}
          <Button className="group rounded-full bg-gradient-to-r from-brand to-brand-light px-8 py-3 text-white shadow-lg shadow-brand/25 transition-all hover:shadow-xl hover:shadow-brand/40 hover:scale-105">
            Try now for free
